...
const Footer = () => {
  const socialLinks = [
    {
      name: "blog",
      url: "https://blog.naver.com/yjjob8877",
      icon: (
        <svg
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/yjjob8877",
      icon: (
    ...
    {
      name: "YouTube",
      url: "https://www.youtube.com/@yjjob",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
